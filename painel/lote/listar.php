...
<script type="text/javascript">
	...
	//Gerar QR Code//
	document.getElementById('btn-gerar-qrcode').addEventListener('click', () => {
	...
	var googleChart = `https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=
	 ${produto}
	 ${produtor}
	 ${avaliacao}
	 ${local}
	`;
	document.getElementById('QRcode').src = googleChart;
