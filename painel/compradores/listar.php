...
//retirar quebra de texto do obs
		...
		<big><a href="#" onclick="editar('{$id}', '{$nome}', '{$telefone}', '{$doc}', '{$email}', '{$logradouro}', '{$cep}', '{$uf}', '{$cidade}', '{$numero}', '{$inscricao}', '{$corretor}',  '{$obs}', '{$pessoa}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>

		<big><a href="#" onclick="mostrar('{$nome}', '{$telefone}', '{$doc}', '{$email}', '{$logradouro}', '{$cep}', '{$uf}', '{$cidade}', '{$numero}',  '{$inscricao}', '{$nome_corretor}',  '{$data_cadF}', '{$obs}', '{$pessoa}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, doc, email, logradouro, cep, uf, cidade, numero, inscricao, corretor, obs, pessoa){
	...
	function mostrar(nome, telefone, doc, email, logradouro, cep,  uf, cidade, numero,  inscricao,  corretor,  data_cad, obs, pessoa){
